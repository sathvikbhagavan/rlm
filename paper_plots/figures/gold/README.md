...
| [`cost_by_tier_across_models.pdf`](cost_by_tier_across_models.pdf) | Recorded billed CHF per successful trajectory, averaged over paid models only | [`plot_gold_efficiency_by_tier.py`](../../scripts/plot_gold_efficiency_by_tier.py) | [`tier_efficiency_across_models.csv`](../../gold/iclr2027/tier_efficiency_across_models.csv) |
