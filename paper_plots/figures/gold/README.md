...
| [`efficiency_frontier.pdf`](efficiency_frontier.pdf) | GPT-5 mini macro-F1 against recorded USD cost per question trajectory | [`plot_main_results.py`](../../scripts/plot_main_results.py) | [`full_benchmark_records.csv`](../../gold/iclr2027/full_benchmark_records.csv) |
