...
async def main(model_name: str, context_size: int) -> None:
    ...
    async def _evaluate_question(_item):
        nonlocal index_match_count, macro_accuracy, macro_objective_length, macro_reaction_f1, macro_valid_path, samples_run, samples_with_cost, total_cost_usd, total_input_tokens, total_output_tokens
        (i, question) = _item
    ...
    await map_async_bounded(
        _evaluate_question,
        list(enumerate(evaluated_questions)),
