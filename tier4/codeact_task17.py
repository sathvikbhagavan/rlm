...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run CodeAct task 17 — SMIRKS sequential 2-reaction chains."
    )
...
async def main(model_name: str, context_size: int, max_chains_per_question: int) -> None:
    ...
    for i, spec in enumerate(evaluated_specs):
        ...
        prompt_question = build_question(spec)
        ...
        with tracer.start_as_current_span(f"codeact_task17_sample_{i}") as sample_span:
            ...
            with using_tracing_attributes(
                ...
                tags=["codeact", "sample", "task17_SMIRKS_SEQUENTIAL_CHAINS"],
            ):
        ...
        predicted_list = parse_chain_response(response_text)
