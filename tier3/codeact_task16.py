...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="CodeAct-Task16_tier3",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run CodeAct task 16 evaluation.")
...
async def main(model_name: str, context_size: int) -> None:
    ...
    with tracer.start_as_current_span("codeact_task16_sample_0") as sample_span:
        ...
        with using_tracing_attributes(
            ...
            tags=["codeact", "sample", "task16_pyridine_product"],
        ):
