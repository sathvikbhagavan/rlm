...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run LLM task 13 new nitrogen atom introduction index evaluation."
    )
    parser.add_argument(
        "--model-name",
        type=str,
...
async def main(model_name: str, context_size: int) -> None:
    ...
    with using_tracing_attributes(
        ...
        tags=["llm-baseline", "sample", "task13_new_nitrogen_atom"],
    ):
