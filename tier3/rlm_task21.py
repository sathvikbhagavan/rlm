...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="RLMs-Task21_tier3",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run RLM task 21 transition-metal reagent index evaluation."
    )
...
def main(model_name: str, context_size: int) -> None:
    ...
    gt_set = set(TASK21_HARDCODED_GROUND_TRUTH_INDICES)
    ...
    with using_tracing_attributes(
        ...
        tags=["run_rlms", "sample", "task21_transition_metal_reagent"],
    ):
    ...
    run.summary["ground_truth/transition_metal_reagent/full_count"] = len(gt_set)
