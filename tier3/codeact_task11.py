...
REACTION_KEY = "cn_bond_formation"
...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="CodeAct-Task11_tier3",
...
async def main(model_name: str, context_size: int) -> None:
    ...
    full_gt_set = set(TASK11_HARDCODED_GROUND_TRUTH_INDICES)

    run = wandb.init(
        project="CodeAct-Task11_tier3",
        config={
    ...
    print(
        ...
        f"ground_truth_in_context={len(ground_truth_in_context_set)}/{len(full_gt_set)}"
    )
    ...
    with tracer.start_as_current_span("codeact_task11_sample_0") as sample_span:
        ...
        with using_tracing_attributes(
            ...
            tags=["codeact", "sample", "task11_cn_connectivity"],
        ):
    ...
    run.summary["ground_truth/cn_bond_formation/full_count"] = len(full_gt_set)
