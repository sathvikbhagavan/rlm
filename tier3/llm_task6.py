...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run LLM task 6 evaluation.")
...
async def main(
    ...
    for i, reaction_key in enumerate(reaction_keys):
        ...
        print(
            f"Ground truth present in context: {len(gt_indices)}/{total_gt_count}, Indices: {gt_indices}"
