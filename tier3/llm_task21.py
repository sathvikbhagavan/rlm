...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run LLM task 21 transition-metal reagent index evaluation."
    )
...
async def main(model_name: str, context_size: int) -> None:
    ...
    run_session_id = f"llm-task21-{uuid.uuid4()}"
    ...
    with using_tracing_attributes(
        ...
        tags=["llm-baseline", "sample", "task21_transition_metal_reagent"],
    ):
