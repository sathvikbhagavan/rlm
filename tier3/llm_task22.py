...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run LLM task 22 HATU+PF6 or T3P reagent index evaluation."
    )
...
async def main(model_name: str, context_size: int) -> None:
    ...
    run_session_id = f"llm-task22-{uuid.uuid4()}"
    ...
    with using_tracing_attributes(
        ...
        tags=["llm-baseline", "sample", "task22_hatu_pf6_or_t3p_reagent"],
    ):
