...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="RLMs-Task16_tier3",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run RLM task 16 pyridine ring product recognition index evaluation."
    )
    parser.add_argument(
        "--model-name",
        type=str,
...
def build_question() -> str:
    ...
    - A reaction matches when at least one product molecule contains a pyridine substructure match.
...
def main(model_name: str, context_size: int) -> None:
    ...
    gt_indices = TASK16_HARDCODED_GROUND_TRUTH_INDICES
    ...
    with using_tracing_attributes(
        ...
        metadata={
            ...
            "ground_truth_definition": "pyridine_smarts_product_match",
        },
        tags=["run_rlms", "sample", "task16_pyridine_product"],
    ):
    ...
    run.summary["ground_truth/pyridine_product/full_count"] = len(gt_set)
