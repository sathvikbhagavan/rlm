...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="RLMs-Task18_tier3",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run RLM task 18 new ring construction index evaluation."
    )
    parser.add_argument(
        "--model-name",
        type=str,
...
def main(model_name: str, context_size: int) -> None:
    ...
    gt_indices = TASK18_HARDCODED_GROUND_TRUTH_INDICES
    ...
    with using_tracing_attributes(
        ...
        tags=["run_rlms", "sample", "task18_new_ring_construction"],
    ):
    ...
    run.summary["ground_truth/new_ring_construction/full_count"] = len(gt_set)
