...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run RLM task 13 new nitrogen atom introduction index evaluation."
    )
    parser.add_argument(
        "--model-name",
        type=str,
...
def main(model_name: str, context_size: int) -> None:
    ...
    gt_indices = TASK13_HARDCODED_GROUND_TRUTH_INDICES
    ...
    with using_tracing_attributes(
        ...
        metadata={
            "sample_index": 0,
            "sample_count": 1,
            "task": "new_nitrogen_atom",
            "ground_truth_definition": "nitrogen_atom_count_delta",
        },
        tags=["run_rlms", "sample", "task13_new_nitrogen_atom"],
    ):
    ...
    if iteration_metrics:
        ...
        wandb.log(
            {
                "sample_idx": 0,
                "sample/0/reaction_key": "new_nitrogen_atom",
    ...
    run.summary["ground_truth/new_nitrogen_atom/full_count"] = len(gt_set)
