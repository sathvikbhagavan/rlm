...
def maybe_init_tracing() -> None:
    ...
    initialized = init_tracing(
        project_name="RLMs-Task19_tier3",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run RLM task 19 quinoline construction index evaluation."
    )
    parser.add_argument(
        "--model-name",
        type=str,
...
def main(model_name: str, context_size: int) -> None:
    ...
    gt_indices = TASK19_HARDCODED_GROUND_TRUTH_INDICES
    ...
    with using_tracing_attributes(
        ...
        metadata={
            "sample_index": 0,
            "sample_count": 1,
            "task": "quinoline_construction",
            "ground_truth_definition": TASK19_GROUND_TRUTH_DEFINITION,
        },
        tags=["run_rlms", "sample", "task19_quinoline_construction"],
    ):
    ...
    if iteration_metrics:
        ...
        wandb.log(
            {
                "sample_idx": 0,
                "sample/0/reaction_key": "quinoline_construction",
    ...
    run.summary["ground_truth/quinoline_construction/full_count"] = len(gt_set)
